...
public class UpdateshoeSteps {
	...
	@Given("open the update product base url") public void open_the_update_product_base_url() {
	...
	int id = shoeId;
	String image= "update image"; String name = "updated Shoe";
	String category = " updated Runnings"; int sizes = 12;
	int price = 1099;
	...
	public void the_response_should_indicate_successful_update() { System.out.println(json.toString());
	}
	}
