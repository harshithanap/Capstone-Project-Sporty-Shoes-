Feature: Retrieve all products from the sports shoe store As a user,
  ...
  Scenario: Retrieve all products successfully
    ...
    Then I should receive a successful response with status code 200 And the response should contain a valid list of sports shoes
